...
DEFAULT_EPOCHS = 70
DEFAULT_DATA_BASE_DIR = 'coco_data'
...
# Dataset Constants
DEFAULT_TRAIN_ANNOT_PATH = 'coco_data/annotations/person_keypoints_train2017.json'
DEFAULT_VAL_ANNOT_PATH = 'coco_data/annotations/person_keypoints_val2017.json'
DEFAULT_TRAIN_IMG_PATH = 'coco_data/'
DEFAULT_VAL_IMG_PATH = 'coco_data/'
